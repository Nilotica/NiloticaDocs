...
import "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/theme/components-var.css";
...
function parseLoaderResponse(storage3, icons, data) {
  ...
  if (data && typeof data === "object") {
    try {
      const parsed = addIconSet(storage3, data);
      if (!parsed.length) {
        checkMissing();
        return;
      }
    ...
    setTimeout(() => {
      ...
      if (storage3.loadIcons && (icons2.length > 1 || !customIconLoader)) {
        parsePossiblyAsyncResponse(
          storage3.loadIcons(icons2, prefix, provider),
          (data) => {
      ...
      if (customIconLoader) {
        icons2.forEach((name) => {
          ...
          parsePossiblyAsyncResponse(response, (data) => {
            ...
            parseLoaderResponse(storage3, [name], iconSet);
          });
        });
        return;
      }
      ...
      if (invalid.length) {
        parseLoaderResponse(storage3, invalid, null);
      }
      if (!valid.length) {
        return;
      }
...
// node_modules/@theojs/lumen/types/index.ts
import { default as default2 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/Announcement.vue";
import { default as default3 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/DocAsideLogo.vue";
import { default as default4 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/DocBox.vue";
import { default as default5 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/DocPill.vue";
import { default as default6 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/DocBoxCube.vue";
import { default as default7 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/DocLinks.vue";
import { default as default8 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/DocTwikoo.vue";
import { default as default9 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/DocVideoLink.vue";
import { default as default10 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/HomeFooter.vue";
import { default as default11 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/HomeUnderline.vue";
import { default as default12 } from "D:/Project/nodejs/NiloticaDocs/node_modules/@theojs/lumen/components/ShareButton.vue";
...
function iconToSVG2(icon, customisations) {
  ...
  if (customisationsWidth === null) {
    height = customisationsHeight === null ? "1em" : customisationsHeight === "auto" ? boxHeight : customisationsHeight;
    width = calculateSize2(height, boxWidth / boxHeight);
  } else {
    width = customisationsWidth === "auto" ? boxWidth : customisationsWidth;
    height = customisationsHeight === null ? calculateSize2(width, boxHeight / boxWidth) : customisationsHeight === "auto" ? boxHeight : customisationsHeight;
  }
  const attributes = {};
  const setAttr = (prop, value) => {
...
function checkIconNamesForAPI2(icons) {
  const valid = [];
  const invalid = [];
  icons.forEach((name) => {
    (name.match(matchIconName2) ? valid : invalid).push(name);
  });
  return {
    valid,
    invalid
...
function parseLoaderResponse2(storage3, icons, data) {
  function checkMissing() {
    const pending = storage3.pendingIcons;
    icons.forEach((name) => {
      if (pending) {
  ...
  if (data && typeof data === "object") {
    try {
      const parsed = addIconSet2(storage3, data);
      if (!parsed.length) {
        checkMissing();
        return;
      }
...
function parsePossiblyAsyncResponse2(response, callback) {
  if (response instanceof Promise) {
    response.then((data) => {
      callback(data);
    }).catch(() => {
...
function loadNewIcons2(storage3, icons) {
  ...
  if (!storage3.iconsQueueFlag) {
    ...
    setTimeout(() => {
      ...
      const customIconLoader = storage3.loadIcon;
      if (storage3.loadIcons && (icons2.length > 1 || !customIconLoader)) {
        parsePossiblyAsyncResponse2(
          storage3.loadIcons(icons2, prefix, provider),
          (data) => {
            parseLoaderResponse2(storage3, icons2, data);
          }
        );
        return;
      }
      if (customIconLoader) {
        icons2.forEach((name) => {
          const response = customIconLoader(name, prefix, provider);
          parsePossiblyAsyncResponse2(response, (data) => {
            const iconSet = data ? {
              prefix,
              icons: {
                [name]: data
            ...
            parseLoaderResponse2(storage3, [name], iconSet);
          });
        });
        return;
      }
      const { valid, invalid } = checkIconNamesForAPI2(icons2);
      if (invalid.length) {
        parseLoaderResponse2(storage3, invalid, null);
      }
      if (!valid.length) {
        return;
      }
      const api = prefix.match(matchIconName2) ? getAPIModule2(provider) : null;
      if (!api) {
        parseLoaderResponse2(storage3, valid, null);
        return;
      }
      const params = api.prepare(provider, prefix, valid);
      params.forEach((item) => {
        sendAPIQuery2(provider, item, (data) => {
          parseLoaderResponse2(storage3, item.icons, data);
        });
      });
    });
  }
...
function mergeCustomisations(defaults, item) {
  ...
  for (const key in item) {
    ...
    if (key in defaultIconSizeCustomisations2) {
...
function iconToHTML2(body, attributes) {
  let renderAttribsHTML = body.indexOf("xlink:") === -1 ? "" : ' xmlns:xlink="http://www.w3.org/1999/xlink"';
  for (const attr in attributes) {
    renderAttribsHTML += " " + attr + '="' + attributes[attr] + '"';
  }
...
var render = (icon, props) => {
  ...
  for (let key in props) {
    ...
    switch (key) {
      ...
      case "flip":
        if (typeof value === "string") {
          flipFromString2(customisations, value);
        }
        break;
      case "color":
        style.color = value;
      ...
      case "rotate":
        if (typeof value === "string") {
          customisations[key] = rotateFromString2(value);
  ...
  const item = iconToSVG2(icon, customisations);
...
var Icon = defineComponent((props, { emit }) => {
  ...
  function getIcon2() {
    ...
    let iconName;
    if (typeof icon !== "string" || (iconName = stringToIcon2(icon, false, true)) === null) {
      return null;
    }
    let data = getIconData2(iconName);
    if (!data) {
      ...
      if (!oldState || oldState.name !== icon) {
        if (data === null) {
          ...
          loader.value = {
            name: icon,
            abort: loadIcons2([iconName], updateIconData)
          };
        }
      }
      return null;
...
// node_modules/@theojs/lumen/analytics/baiduAnalytics.ts
...
// node_modules/@theojs/lumen/analytics/googleAnalytics.ts
var googleAnalytics_default = ({ id }) => {
  if (false)
    mountGoogleAnalytics(id);
};

// node_modules/@theojs/lumen/analytics/umamiAnalytics.ts
...
function handleClick(event, prelink) {
  if (!prelink) return;
  const textToCopy = prelink.install || "没有提供可复制的内容";
  if (prelink.copy) {
    event.preventDefault();
    navigator.clipboard.writeText(prelink.install).then(() => {
...
export {
  default2 as Announcement,
  default3 as DocAsideLogo,
  default4 as DocBox,
  default6 as DocBoxCube,
  default7 as DocLinks,
  default5 as DocPill,
  default9 as DocVideoLink,
  default10 as HomeFooter,
  default11 as HomeUnderline,
  Icon,
  default12 as ShareButton,
  default8 as Twikoo,
  baiduAnalytics,
  getVideo,
